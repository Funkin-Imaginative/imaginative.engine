...
class CoolUtil {
	...
	/** Quick Function to Fix Save Files for Flixel 5
		if you are making a mod, you are gonna wanna change "ImagEngine" to something else
		so Base Engine saves won't conflict with yours
	**/
	inline public static function getSavePath(folder:String = 'ImagEngine'):String {
		@:privateAccess
