	...
	override function update(elapsed:Float) {
		...
		if (controls.ACCEPT) {
			switch(options[curSelected]) {
				...
				case 'Icon Editor'://winning and animated support bitches
					LoadingState.loadAndSwitchState(new IconEditorState(), false);
			}
			FlxG.sound.music.volume = 0;
			#if PRELOAD_ALL FreeplayState.destroyFreeplayVocals(); #end
		}
