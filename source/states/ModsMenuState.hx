	...
	public function new(folder:String) {
		...
		if (FileSystem.exists(path)) {
			...
			if (rawJson != null && rawJson.length > 0) {
				...
				if (name != null && name.length > 0) this.name = name; else if (name == 'Name') this.name = folder;
				if (description != null && description.length > 0) this.description = description; else if (description == 'Description') this.description = 'No description provided.';
