...
class MainMenuState extends MusicBeatState {
	...
	override function create() {
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Imaginative Engine v" + engineVersion, 12);
		...
		if (!selectedSomethin) {
			...
			if (controls.ACCEPT) {
				if (optionShit[curSelected] == 'donate') CoolUtil.browserLoad('https://ninja-muffin24.itch.io/funkin');
					...
					if (ClientPrefs.data.flashingLights) FlxFlicker.flicker(magenta, 1.1, 0.15, false);
