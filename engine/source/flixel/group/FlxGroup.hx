...
class FlxTypedGroup<T:FlxBasic> extends FlxBasic
{
	...
	override public function update(elapsed:Float):Void
	{
		...
		while (i < length)
		{
			...
			{
				if (basic is imaginative.backend.objects.SelfContainedSprite)
					cast(basic, imaginative.backend.objects.SelfContainedSprite).sprite_update(elapsed);
				else
	...
	override public function draw():Void
	{
		...
		while (i < length)
		{
			...
			{
				if (basic is imaginative.backend.objects.SelfContainedSprite)
					cast(basic, imaginative.backend.objects.SelfContainedSprite).sprite_draw();
				else
					basic.draw();
			}
		}
